...
class WBQRCodeCardViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // 3.布局图片容器
        iconView.bounds = CGRectMake(0, 0, 300, 300)
...
//        iconView.backgroundColor = UIColor.redColor()
    ...
    private func creatQRCodeImage() -> UIImage{
        ...
        // 3.设置需要生成二维码的数据
        filter?.setValue("安人多梦".dataUsingEncoding(NSUTF8StringEncoding), forKey: "inputMessage")
    ...
    */
    private func creteImage(bgImage: UIImage, iconImage: UIImage) -> UIImage
    {
        ...
        iconImage.drawInRect(CGRectMake(X, Y, W, H))
        // 4.取出绘制号的图片
